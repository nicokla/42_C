...
test_line () {
	...
	sleep .250
	echo >> out.res
	leaks microshell > leaks.res2 2> /dev/null
	echo $@ >> leaks.res
	leaks microshell >> leaks.res
	echo >> leaks.res
	if grep "ROOT LEAK" < leaks.res2 > /dev/null 2> /dev/null ; then
		printf "\e[0;31mLEAKS\n\e[0m"
	fi
...
gcc -g -Wall -Werror -Wextra -DTEST_SH microshell_ncolomer.c -o microshell
printf "\e[1;36mTest\n\e[0m"
...
rm -rf microshell.dSYM leaks.res2
